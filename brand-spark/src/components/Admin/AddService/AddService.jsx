            ...
            <table className="w-full text-sm text-gray-400">
              ...
              <tbody>
                <tr className="bg-neutral-800 border-b dark:border-neutral-600 hover:bg-neutral-700 transition-all duration-200">
                  <td className="px-6 py-4 text-center font-medium text-gray-200 whitespace-nowrap">Apple MacBook Pro 17"</td>
                ...
                <tr className="bg-neutral-800 border-b dark:border-neutral-600 hover:bg-neutral-700 transition-all duration-200">
                  <td className="px-6 py-4 text-center font-medium text-gray-200 whitespace-nowrap">Microsoft Surface Pro</td>
                ...
                <tr className="bg-neutral-800 hover:bg-neutral-700 transition-all duration-200">
                  <td className="px-6 py-4 text-center font-medium text-gray-200 whitespace-nowrap">Magic Mouse 2</td>
